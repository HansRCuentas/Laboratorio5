...
public class Esfera {
	/**
	 * 
	 * 0,4,12,8 / | \ 1 / 5|13 \ 1 ---------|--------- 9 | | | | | | 2 | | | |
	 * 6|14 | 2 ---------|--------- 10 \ | / \ | / 3 segmentos vérticales (1/2
	 * vuelta) 3,7,15,11
	 * 
	...
	public Esfera(float radio, int segmentosH, int segmentosV) {
		...
		float[] normales = new float[segmentosH * segmentosV * 4 * 3]; // 4
																		...
																		// (x y
																		// z)
		indices = new short[segmentosH * segmentosV * 12]; // 6 vért.
															// (c/cuadrado) x 2
		int i = 0;
	...
	public void dibuja(GL10 gl) {
		...
		/*
		 * Renderiza las primitivas desde los datos de los arreglos (vertices e
		 * indices)
		 */
